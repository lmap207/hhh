            ...
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" method="post" action="/link/{{$link['id']}}">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="lname" class="tpl-form-input" id="user-name" placeholder="" value="{{$link['lname']}}">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="order" class="tpl-form-input" id="user-name" placeholder="" value="{{$link['order']}}">
                        </div>
                    </div>
                    {{csrf_field()}}
                    {{method_field('PUT')}}
