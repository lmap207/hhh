            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/link/create" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$v['id']}}</td>
                                <td class="am-hide-sm-only">{{$v['lname']}}</td>
                                <td>{{$v['url']}}</td>
                                <td>{{$v['order']}}</td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="/link/{{$v['id']}}/edit">
                                        ...
                                        <form action="/link/{{$v['id']}}" method="post">
                                            ...
                                            {{csrf_field()}} {{method_field('DELETE')}}删除
                                            </button>  
                                        </form>     
                                        </div>
                                </td>
