                    ...
                    <!-- 权限  -->
                     <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            ...
                            <label><input type="radio" name="qx" class="tpl-form-input" id="user-name" placeholder="" value="{{$users['qx']}}" {{$users['qx'] == 0 ? 'checked' : '' }} >普通用户</label>
                            
                            <label><input type="radio" name="qx" class="tpl-form-input" id="user-name" placeholder="" value="{{$users['qx']}}" {{$users['qx'] == 1 ? 'checked' : '' }} >管理员</label>
                        </div>
                    </div>
                     <div class="am-form-group">
